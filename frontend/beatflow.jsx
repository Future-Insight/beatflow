    ...
    <header className="hero">
      <div className="brand-row">
        ...
        <div className="brand-toolbar">
          ...
          <a className="tb-btn" href="https://future-insight.github.io/beatflow/" target="_blank" rel="noopener" title={t("brand.live")} aria-label="Live app">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" width="14" height="14">
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="ft-links">
        ...
        <a href="https://future-insight.github.io/beatflow/" target="_blank" rel="noopener" className="ft-link">future-insight.github.io/beatflow ↗</a>
      </div>
    </footer>
  );
}
